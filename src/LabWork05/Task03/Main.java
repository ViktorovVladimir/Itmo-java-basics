...
public class Main {
    ...
    private static String biakaReplace(String text, String patternSearch, String patternReplace) {

        return text.replaceAll(patternSearch, patternReplace);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(biakaReplace(text, "(?i)бяка", "[вырезано цензурой]"));
    }
